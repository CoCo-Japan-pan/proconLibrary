...
data:
  ...
  attributes:
    ...
    PROBLEM: https://atcoder.jp/contests/tessoku-book/tasks/tessoku_book_ad
    links:
  ...
  bundledCode: "#line 1 \"verify_tests/modint_static/modint_static.test.cpp\"\n#define\
    ...
    ;\n}\n"
  code: "#define PROBLEM \"https://atcoder.jp/contests/tessoku-book/tasks/tessoku_book_ad\"\
    \n\n// \u63D0\u51FA\u6642\u306Bassert\u306F\u30AA\u30D5\n#ifndef DEBUG\n#ifndef\
    \ NDEBUG\n#define NDEBUG\n#endif\n#endif\n\n#include <bits/stdc++.h>\n#include\
    \ \"myLibrary/modint_static.hpp\"\nusing namespace std;\nusing ll = long long;\n\
    using mint = mint1000000007;\n\n#define ALL(x) (x).begin(), (x).end()\ntemplate\
  ...
  requiredBy: []
  timestamp: '2023-03-03 14:45:43+09:00'
